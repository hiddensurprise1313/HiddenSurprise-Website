        ...
        {normalizedItems.map((item, index) => {
          ...
          return (
            <Card
              ...
              style={{ width: cardWidth, height: cardHeight, borderRadius: cardRadius, cursor: 'pointer' }}
              href={item.href}
              target={item.target}
              ...
              onClick={(e) => {
                if (!dragMovedRef.current && (onCardClick || item.onClick)) {
                  e.stopPropagation();
            ...
            >
              ...
              />
              <div className="infinite-spiral__overlay" />
            </Card>
          );
        })}
      </div>
